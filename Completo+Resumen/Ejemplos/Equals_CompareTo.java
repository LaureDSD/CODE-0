...
public class Equals_CompareTo implements Comparable<Vehiculo>{
    private String marca;
    private String modelo;
    private double precio;

    public Equals_CompareTo(String marca, String modelo, double precio) {
        this.marca = marca;
        this.modelo = modelo;
        this.precio = precio;
    }
    ...
    public int compareTo(Vehiculo v) {
       if (this.marca.equals(v.getMarca())) {
           if(this.precio==v.getPrecio()){
               //precio
               return Double.compare(this.precio,v.getPrecio());
           }
           //modelo
